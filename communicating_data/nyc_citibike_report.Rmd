...
As this data involves location extra care needs to be taken that no information 
from the public dataset will be used to uniquely identify individual users of the 
service. The dataset provided has no names of individuals or any kind of id 
that might be used to track the behaviour of a particular person, only year 
of birth and gender are available. 
