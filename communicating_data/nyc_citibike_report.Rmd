...
undocked at a start station and docked at a destination station. We will 
plot hires against time/demographics and show a map where the number of hires 
is visualised.
...
faults or not enough bikes available for users wishing to travel.
...
Hires are lower in winter months, higher in summer. Citi Bike could do 
promotions at quieter times of year to try and encourage more usage. They could 
further examine the top days and was there anything they did to boost hires in 
the past and to repeat anything similar in future. On 21 days hires were 
barely measurable with only a single hire. Check for reasons why this may be 
e.g. was the weather particularly severe, were there road problems, was 
...
As might be expected, this shows peak movement before and after  
"office hours" (traditionally 9-5 with an hour commuting either side, this is 
marked by yellow bars). Remember this was before COVID-19 when many more people commuted into city centre offices for work. Could Citi Bike do deals with 
larger organisations to help workers be more physically active to improve 
wellbeing and reduce business expenses ?Hires are remarkably consistent from 
10am to 3pm as seen by the dip in the middle of the day. Incentivise tourists 
or retired people to encourage more use during these hours. No real sign of 
workers going on bike trips during lunch (12-2pm). Exceptionally light usage 
from 1-4am, target late shift workers in e.g. health/emergency or leisure 
sectors.
...
* Promote better short passes deals for fair weather "day trip" users, these are potential new subscribers who might wish to experiment with the service before 
commiting to a full yeqr.
* Heaviest usage during weekday work commute times. Work with employers for 
Citi Bike to be part of employee benefit schemes.
* Males use the service considerably more than females. Quick win could be to attempt to grow female usage through targeted marketing campaigns and working 
with female-oriented groups in New York City.
* Developers/designers should check whether the user information interface provided could be adjusted to make birth_year optional to improve quality of age data 
