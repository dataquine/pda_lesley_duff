...
The main Key Performance Indicatior (KPI) that CitiBike could use to measure 
...
* User docks bike
* CitiBike checks the duration of the hire and charges any payment due in excess of user type allowances
...
CitiBike about hires is accurate e.g. are the date/time stamps correct?

CitiBike bikes hire process involves users using their mobile phones to 'unlock'
bikes. CitiBike will be unable to determine from this dataset whether there are 
...
CitiBike holds but not made public. We are unable to claim how well this sample 
...
diagram. This highlighted a possible issue with data quality regarding age for 
CitiBike to examine later. 
...
with a peak in August. CitiBike could do promotions at quieter times of year to 
try and even out usage. Or look at the top days and was there anything CitiBike 
...
CitiBike should check their records for reasons why this may be. Was the 
weather particularly bad, were there road problems, were CitiBike having 
...
use if bike trip started during these hours. Not really any sign of workers going on bike trips during lunch breaks. Perhaps incentivise tourists able to move at these times. Very little usage from 1-4am, could CitiBike target shift workers e.g. health/emergency workers or the entertainment sectors.
...
likely to experiment with short passes for the CitiBike service in good weather?
Are tourists accounting for these increases? Maybe on signing up for the 
service CitiBike could ask for optional data around what use the user had 
planned.
...
suggesting satisfaction with the service CitiBike offers. Use this vote of 
