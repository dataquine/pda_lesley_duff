...
initiallu examine the quality of the data. Visualisations will be created that break down hires by different time periods showing different demographics and user types. Maps will show the geographical spread by showing the location of stations used for hires. We will also try and visualise which stations are in active use at different times of day to identify any commuter-related directionality. Since payment schemes incentivise short journeys we will look at the durations of hires.
...
a full list of available stations so are unable to guage how our sample aligns 
...
Riding a bike usually involves people learning to balance themselves. If 
someone has never learned to ride a bike they will initially be unable to use 
these services. There is no indication of people who may wish to do so but are 
physically unable.

Possible undercoverage? The sample is only for over 4,000 trips over the 
course of 2018 for just 10 different bikes and just over 50 stations. We can
only examine that particular year in isolation without testing whether there are 
year-to-year trends such seasonal variations.
...
was created to do a small amount of cleaning/wrangling was done to add extra time-related columns to thedata for convenience when visualising the dataset as 
plots.
...
For some visualisations the images raised questions regarding particular points 
of interest. For these items I supplemented plots with some tabular information 
...
This bar plot shows the pattern of hires for each day of the week across the 
whole of 2018 and highlighting which days are weekday/weekend usage.

Hires are lower at weekends than weekdays. There should be scope for promoting 
more leisure trips within the current service capacity. Could leisure promotions
at weekends help compensate for loss of local weekday commuters. There is no 
...
into city centre offices for work. Could Citi Bike do deals with larger 
organisations to help workers be more physically active to improve wellbeing and 
reduce business expenses? Hires are remarkably consistent from 11am to 3pm as 
seen by the dip in the middle of the day. Incentivise tourists or retired people 
to encourage more use during these hours. No real sign of workers going on bike 
trips during lunch (12-2pm). Exceptionally light usage from 1-4am, target late 
shift workers in e.g. health/emergency or leisure sectors such as the nearby 
...
a short pass first - discounts to "upgrade" to full membership for new 
customers. Proportion of customers seems highest in the summer months. Are 
people more likely to experiment with short passes for the Citi Bike service in 
good weather? Are tourists accounting for higher summer customers?  
...
special promotions those months in the previous year?
...
This suggests there could be well over 2,000 available females in this sample 
not using the service compared to males.
...
bike when younger? Are there concerns about personal safety travelling alone or 
...
Other potential cause, it may be worth doing some technical checks with 
web/app staff - was there something in the user interface that was defaulting 
to a birth year of 1969 that people maybe simpl didn't bother changing?
...
```
This map shows the locations where hires started, the larger the circle 
the more hires.
...
This map shows the locations where hires ended, the larger the circle 
the more hires.
...
close to Jersey City than those going long distances elsewhere.

What is striking comparing start stations and end stations maps is how similar 
...
Street is by far the most popular individual station with used 433 times as 
start station and 577 as end station. This particular station is positioned 
between the 'old' downtown area and the newer multi-storey residential 
apartments and business blocks further east. Such locations may make for a 
higher density of potential users so it might be worth positioning stations 
close to taller buildings. Is is also very close to [Grove Street station (PATH)](https://en.wikipedia.org/wiki/Grove_Street_station_(PATH)) train station 
which may suggest people using the bikes for a leg of a longer journey via 
public transport.

In general the other more popular stations are closer to the heart of Jersey 
City in high rise accommodation or business, many towards the newer waterfront 
areas where many businesses are located and entertainment such as casinos. These 
hires could possibly also be people connecting with ferries if they are 
travelling to/from further away. Others are nearby stops on the light railway 
system. There may be scope for experimenting with "park and ride" schemes to 
link up with other public transport systems.

## Other insights
### Station usage

We'll now take a closer look at patterns of from (`start_station)` to 
(`end_station`) journeys to see which routes are more popular.
...
darker the blue the more hires. There are two grids showing patterns at 
...
This plot shows number of hires broken down by duration and user type. Duration 
is the time taken between a bike being undocked at a starting station and docked
at a destination 'end' station.
...
trips lasting less than 10 minutes. Users find Citi Bike worthwhile especially 
for relatively short journeys outweighing any inconvenience of time spent 
walking to find a bike.
Subscribers with yearly membership massively favour journeys under 10 minutes 
reinforcing that those who use the service regularly are making very short 
...
As mention previously there are relatively few customer users but they may be 
...
* Males use the service considerably more than females. Quick win could be to 
attempt to grow female usage through targeted marketing campaigns and working 
with female-oriented groups in New York City.
